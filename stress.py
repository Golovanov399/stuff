...
parser.add_argument("stupid_file", metavar="<naive soln exec>", help="Executable file of the solution to test against")
...
while True:
	...
	sys.stdout.flush()
	our = sp.run(os.path.join(".", args.main_file), input=inp, capture_output=True).stdout.decode()
	clear_last_row()
